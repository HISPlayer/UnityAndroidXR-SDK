...
Please, download the sample here: [**AndroidXRSample**](https://downloads.hisplayer.com/Unity/XR/HISPlayer_AndroidXR_Sample_1.0.1.unitypackage) (no need to download it if you have received it in the email). 
