...
Please check the `Assets/AndroidXRSample/Scripts/Sample/HISPlayerDownloadSample.cs` script. The script must inherit from `HISPlayerDownloadManager`. It is also necessary to add the `using HISPlayerAPI;` dependency.
